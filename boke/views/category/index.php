         ...
         <div class="row">
             <div class=" col-md-1 col-sm-12 col-lg-1">
                 <div class="form-group">
                     <label for="cate" class=" col-md-12 col-sm-12 col-lg-12">共 <?=$count;?> 个 分 类</label>
                 </div>
             </div>
             ...
             <div class="form-group col-md-1 col-sm-12 col-lg-1">
                 <a id="getdatabtn" href="<?=Url::toRoute('/category/add')?>" class="btn btn-warning">添加分类</a>
             </div>
         </div>
         <section id="no-more-tables">
             <table class="table table-bordered table-striped table-condensed cf wxgzh">
                   <thead>
                       ...
                       <th width="20%" class="blue-bg">分类名称</th>
                       <th width="10%" class="blue-bg">排序</th>
                       <th width="10%" class="blue-bg">是否显示</th>
                       <th width="20%" class="blue-bg">排序字段</th>
                       <th width="20%" class="blue-bg">添加时间</th>
                    ...
                    <?php else:?>
                        <?php foreach($list as $k=>$v): ?>
                           <tr>
                               ...
                               <td class="last-td" myid="<?=$v['id']?>"><a href="<?=Url::toRoute(['/category/edit','id'=>$v['id']])?>" class="glyphicon glyphicon-pencil"></a> | <a  href="javascript:;"  class="glyphicon glyphicon-trash"></a></td>
                           </tr>
                        <?php endforeach?>
                      <?php endif ?>
                   </tbody>
