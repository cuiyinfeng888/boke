        ...
        <div class="row col-sm-12  col-lg-12 ">
            <form class="form-horizontal" role="form" action="" method="post">
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="name" name="title" required placeholder="请输入标题">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="require-star">*</div>
                    <div class="col-sm-6">
                        <input type="number" class="form-control" id="name" name="sort" required placeholder="排序数字越大越靠前">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea name="content"  id="content" cols="30" rows="200" style="height:500px;" required></textarea>
                    </div>
                </div>
                <div class="form-group">
